...
import 'ai_bncc_module_model.dart';
...
/// Enum para modos de chat
enum ChatMode {
  module,
  general,
}

/// Widget stub para ChatScreen
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Chat - Em desenvolvimento'),
        leading: IconButton(
      ...
      body: const Center(
        child: Text('Funcionalidade de chat em desenvolvimento'),
      ),
    );
  }
}

/// Classe que contém os dados dos cursos de matemática
class Matematica {
  static const Map<String, Map<String, List<String>>> cursos = {
    'Matemática Básica': {
      ...
      'Médias': ['Média aritmética', 'Média ponderada', 'Moda e mediana'],
      'Tabelas': [
    ...
    'Trigonometria': {
      ...
      'Razões trigonométricas': [
        ...
        'Razões dos ângulos notáveis',
        'Identidades trigonométricas'
      ],
      'Funções': ['Função seno', 'Função cosseno', 'Função tangente'],
    },
    'Cálculo': {
      'Limites': [
        'Conceito de limite',
